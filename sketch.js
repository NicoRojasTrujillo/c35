...
button2.size(50, 50);
button2.mouseClicked(dropFruit);
...
function draw() {
  ...
  if (collide(fruit, bunny, 80) == true) {
    ...
    bunny.changeAnimation("eating"); // Change bunny's animation to 'eating'
    bunny.animation.rewind(); // Reset the animation to the beginning
